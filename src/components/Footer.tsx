      ...
      <div className="container">
        <div className={styles.top}>
          <div className={styles.brand}>
            <span className={styles.name}>Senthil Royan</span>
            <span className={styles.tagline}>Lead Product Designer · AI Product Designer · UX Strategist</span>
          </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; {currentYear} Senthil Royan. All rights reserved.
          </p>
          <button
            onClick={scrollToTop}
